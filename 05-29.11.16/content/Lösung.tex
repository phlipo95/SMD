...
\subsection*{2)}
In den Plots sind in der Reihenfolge $g_1$, $g_2$ und $g_3$ zu sehen. Im ersten wurden die Messwerte auf die Graden Projeziert und die Populationen in jeweils einen Histogramm dargestellt.
\begin{figure}
  \centering
